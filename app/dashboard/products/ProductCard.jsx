    ...
    return (
        <div className="group bg-white backdrop-blur-xl rounded-3xl overflow-hidden border border-pink-200 hover:border-pink-400 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/30">
            <div className="relative h-56 bg-gradient-to-br from-pink-100 to-pink-200 overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-gradient-to-r from-pink-500 to-pink-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                    -{product.discount}%
                </div>
                {product.stock < 10 && (
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between pb-4 mb-4 border-b border-pink-200">
                    <div>
                        <div className="text-2xl font-bold text-pink-600">${product.lowprice}</div>
                        {product.highprice && (
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex-1 bg-gradient-to-r from-red-500 to-pink-600 text-white py-2.5 rounded-xl font-semibold hover:from-red-600 hover:to-pink-700 transition-all flex items-center justify-center gap-2 shadow-lg"
                    >
                        <Trash2 size={16} />
                        Delete
                    </button>
