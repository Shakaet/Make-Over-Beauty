        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white col-span-2 rounded-3xl shadow-xl p-6 border border-pink-100">
              ...
              <p className="text-gray-600 text-sm mb-6">Monthly order trends</p>
              <div className="h-64">
                <AreaChart />
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 border border-pink-100">
              ...
              <p className="text-gray-600 text-sm mb-6">Latest transactions</p>

              <div className="space-y-4">
                {orders.slice(0, 3).map((order) => (
                  <div
                    key={order.invoiceId}
                    className="flex items-center justify-between p-3 bg-pink-50 rounded-xl hover:bg-pink-100 transition-colors duration-300"
                  >
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border border-pink-100">
            ...
            <p className="text-gray-600 text-sm mb-6">Best selling items</p>
