    ...
    try {
      ...
      if (data.success && data.data.length > 0) {
        ...
        setFormData({
          ...
          sections:
            existingSettings.sections.length > 0
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-[var(--pink)] mt-2">
              Configure your website sections and content
            </p>
          </div>
          <div>
            <button
        ...
        {!loading && (
          <div className="space-y-6">
            ...
            {formData.sections.map((section, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-xl p-8 border-4 border-pink-200"
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-[var(--pink)]">
                    Section {index + 1}
                  </h2>
                  <button
                    type="button"
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleSectionChange(index, "eyebrow", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <textarea
                        value={section.copy}
                        onChange={(e) =>
                          handleSectionChange(index, "copy", e.target.value)
                        }
                        className="w-full px-4 py-2 border-2 border-pink-200 rounded-lg focus:border-pink-500 focus:outline-none"
                        rows="3"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={section.cta}
                        onChange={(e) =>
                          handleSectionChange(index, "cta", e.target.value)
                        }
                        className="w-full px-4 py-2 border-2 border-pink-200 rounded-lg focus:border-pink-500 focus:outline-none"
                    ...
                    <div>
                      ...
                      <div className="flex gap-4">
                        <button
                          type="button"
                          onClick={() =>
                            handleSectionChange(index, "align", "left")
                          }
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            handleSectionChange(index, "align", "right")
                          }
                          className={`flex-1 py-2 rounded-lg font-medium transition-colors ${
                            section.align === "right"
                              ? "bg-pink-500 text-white"
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6 px-20">
            <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-white border-b-4 border-pink-200 p-6 flex justify-between items-center">
                <h2 className="text-xl font-bold text-[var(--pink)]">
                  Preview
                </h2>
                <button
                ...
                {formData.sections.map((section, index) => (
                  <div
                    ...
                    className={`flex gap-8 items-center mb-8 ${
                      section.align === "right" ? "flex-row-reverse" : ""
                    }`}
                  >
                    {imagePreviews[`image${index + 1}`] && (
                      <img
