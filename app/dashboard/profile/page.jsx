...
export default function Profile() {
  ...
  console.log("Profile Component - User:", user, role);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-2 mb-8 overflow-x-auto">
              {["profile", "security", ...(isAdmin ? ["admin"] : [])].map(
                (tab) => (
                  <button
                    key={tab}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-600 bg-pink-50 rounded-xl p-4">
                        {userData.bio}
                      </p>
                    )}
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {adminFeatures.map((feature, index) => (
                      <div
                        key={index}
                        className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300"
                      >
