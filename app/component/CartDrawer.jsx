                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="mt-1 text-sm text-green-600">
                      You're logged in and ready to checkout.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <>
      ...
      >
        ...
        <div className="border-[#FFD6DE] p-4 space-y-2 text-[#FF5A7A]">
          <label className="text-sm font-medium text-[var(--rose)]">
            Have a coupon?
          </label>
            ...
            <button
              ...
              className={`w-full ${
                user
                  ...
                  : "bg-[#FF5A7A]"
              } text-white py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-[1.02] relative overflow-hidden`}
            >
