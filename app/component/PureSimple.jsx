  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto px-4 text-center">
        {/* Title */}
        <h1 className="text-2xl md:text-3xl font-bold text-[var(--pink)] mb-8 drop-shadow">
          কি খুঁজছেন?
        </h1>

        {/* Filter Pills */}
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <span className="flex items-center gap-2 px-4 py-2 rounded-full border border-[var(--pink)] bg-[var(--light)] text-xs text-[var(--pink)] font-medium">
        ...
        <a
          ...
          অর্ডার করতে CALL AT 01780326279
        </a>
      </div>
    </section>
  )
