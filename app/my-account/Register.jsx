...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    createRegistered(safeData.email, password)
      .then((res) => {
        return updateUserProfile(res.user, profileUpdates).then(() => {
          //  toast.success("Profile Updated")
          console.log(safeData);
          return axios.post(
            "hhttps://bloomingbeauty.vercel.app/api/users",
            safeData,
          );
        });
      })
