...
const Login = () => {
  ...
  const validate = (data) => {
    const newErrors = {}
    if (!patterns.email.test(data.email.trim())) newErrors.email = 'Invalid email.'
    ...
    <div>
      ...
      <form className=" shadow-lg rounded-2xl p-6 md:p-8 space-y-5" onSubmit={handleSubmit} noValidate>
        ...
        <div className="flex items-center justify-between">
          ...
          <button type="button" onClick={handleclick} className="text-sm text-black/70 hover:text-black underline underline-offset-2">Lost your password?</button>
        </div>
